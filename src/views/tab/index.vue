    ...
    <el-dialog :visible.sync="dialogVisible" :title="dialogType==='edit'?'Edit Role':'New Role'">
      <el-form :model="role" label-width="80px" label-position="left">
        <el-form-item label="Name">
          <el-input v-model="role.itemName" placeholder="Role Name" />
        </el-form-item>
...
import { getRoutes, getRoles, addRole, deleteRole, updateRole, getDrivers, getWarehouseItems } from '@/api/role'
